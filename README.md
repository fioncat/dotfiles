...
- [Hyprland (Wayland)](https://hyprland.org/): [My config](hyprland)
- [i3wm (X11)](https://i3wm.org/): [My config](i3wm)

The hyprland has a much better performance, but some softwares might not work (like [flameshot](https://flameshot.org/)).
